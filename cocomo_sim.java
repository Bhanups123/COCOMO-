 ...
 */
public class cocomo_sim extends javax.swing.JFrame {
...
//     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Choose class of your software:");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jRadioButton2.setText("Embedded");
        ...
        jRadioButton3.setText("Semi-Detached");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jRadioButton4.isSelected()){
            ...
            new cocomo_sim2(radiotext).setVisible(true);
        }
            ...
            javax.swing.JOptionPane.showMessageDialog(cocomo_sim.this,"You didn't selected a class");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cocomo_sim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cocomo_sim().setVisible(true);
            }
        });
    }
